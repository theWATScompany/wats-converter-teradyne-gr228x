...
The Teradyne GR228X is an in-circuit test system used in electronics manufacturing. This converter imports the GR228X log output into WATS as UUT reports, preserving test step results and measurements.
