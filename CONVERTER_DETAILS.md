# Technical Details: Teradyne ICT GR228X
...
Converts Teradyne GR228X in-circuit test result files to WATS UUT reports.
...
|-----------|---------|--------|
| `(S` | `SHORTS test, failed` | <!-- TODO: describe effect --> |
| `(O` | `OPENS test, failed` | <!-- TODO: describe effect --> |
| `(B` | `BUSTEST, failure caused by bus` | <!-- TODO: describe effect --> |
| `(C` | `SCRATCHPROBING connection failure` | <!-- TODO: describe effect --> |
| `(F` | `CONTACT fixture failure` | <!-- TODO: describe effect --> |
